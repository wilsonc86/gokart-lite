...
var todaysburnsEnv = {
    ...
    layers:[{
        ...
        featureCountControl:{
            options:{
                html:"<div style='color:#2a044e;font-weight:bold;font-size:18px'>Total Todays's Burn: <span id='todaysburns_count'></span> </div>",
        ...
        featureCountControl:{
            options:{
                html:"<div style='color:#2a044e;font-weight:bold;font-size:18px'>Total Yesterdays's Burn: <span id='yesterdaysburns_count'></span> </div>",
